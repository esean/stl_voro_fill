...
double rcon = 3.1/9.0;
const double arad=4.8,brad=arad*rcon; // 3.1;
//const double arad=6,brad=3.5;
...
const double z_min=-1,z_max=brad+0.5; //4; //-brad-0.5,z_max=brad+0.5;
